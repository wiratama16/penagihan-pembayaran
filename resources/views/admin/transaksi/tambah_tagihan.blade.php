                ...
                <div class="col-sm-12 col-xl-12">
                    <div class="bg-light rounded h-100 p-4">
                        ...
                        <form action="{{route('admin.transaksi.store')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <input type="text" class="form-control" id="jenis_tagihan" name="jenis_tagihan" required><br><br>
                        
                            <label for="tanggal_tagihan">Tanggal Tagihan:</label><br>
                            <input type="date" class="form-control" id="tanggal_tagihan" name="tanggal_tagihan" required><br><br>
                        
                            <label for="jumlah_tagihan">Jumlah Tagihan:</label><br>
                            <input type="number" class="form-control" id="jumlah_tagihan" name="jumlah_tagihan" required><br><br>
                        
                            <label for="tanggal_jatuh_tempo">Tanggal Jatuh Tempo:</label><br>
                            <input type="date" class="form-control" id="tanggal_jatuh_tempo" name="tanggal_jatuh_tempo" required><br><br>
                        
                            <label for="rincian_tagihan">Rincian Tagihan:</label><br>
                            <textarea class="form-control" id="rincian_tagihan" name="rincian_tagihan" rows="4" required></textarea><br><br>
                        
                            <label for="no_rekening">Nomor Rekening:</label><br>
                            <input type="text" class="form-control" id="no_rekening" name="no_rekening" required><br><br>
                            ...
                            <select class="form-select" id="status" name="status" required>
                                ...
                                <option value="sedang_divalidasi">Sedang divalidasi</option>
