                    ...
                    <div class="bg-light rounded h-100 p-4">
                        <h6 class="mb-4">Tambah Pelanggan</h6>
                            <form action="{{route('admin.pelanggan.store')}}" method="post" enctype="multipart/form-data">
                                ...
                                <input type="text" class="form-control" id="nama" name="nama_pelanggan" required><br><br>
                                ...
                                <input type="password" class="form-control" id="email" name="kata_sandi" required><br><br>
                            
                                <label for="telepon">Nomor Telepon:</label><br>
                                <input type="number" class="form-control" id="telepon" name="no_telepon" pattern="[0-9]{10,14}" required><br><br>
                            
                                <label for="alamat">Alamat:</label><br>
                                <textarea class="form-control" id="alamat" name="alamat" rows="4" required></textarea><br><br>
